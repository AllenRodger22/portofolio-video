...
const AboutMe: React.FC = () => {
  const topics = [
    { title: "Specialization", text: "25-year-old Brazilian video editor focused on high-retention short-form content." },
    { title: "Experience", text: "1 year of hands-on experience creating edits that hook fast and hold attention." },
    { title: "Professionalism", text: "Clear communication, fast responses, and absolute respect for deadlines." },
    { title: "Value", text: "Consistency and clarity to help you scale your digital presence without the stress." }
  ];
